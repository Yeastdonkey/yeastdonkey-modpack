...
MODS_DIRS = ["mods", "shaderpacks", "resourcepacks"]
SOURCES_DIR = "sources"
...
def find_pw_tomls():
    ...
    for directory in MODS_DIRS:
        pattern = os.path.join(directory, "*.pw.toml")
...
def parse_github_url(url):
    # e.g. https://github.com/user/repo/releases/download/v1.2.3/file.jar
...
def main():
    ...
    for path in pw_files:
        try:
            ...
            # Force override for mod-loading-screen
